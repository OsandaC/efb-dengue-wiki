...
- **DN2 chromatin is driven by T-BET, AP-1, and EGR motifs:** Motif enrichment analysis of DARs between DN2 and switched memory identified T-BET, ISGF3, AP-1 (JUN/FOSB/FOSL1/FOSL2), and EGR as the top DN2-enriched motifs. Isotype-[[Switched Memory B Cell|switched memory]] was enriched for EBF, NF-κB, and OCT2 motifs. T-BET binding profiles (ChIP-seq from ENCODE) confirmed enrichment at GAS7, TNFRSF1B, ITGAX, ZAP70, and TBX21 loci in DN2/aN cells.
