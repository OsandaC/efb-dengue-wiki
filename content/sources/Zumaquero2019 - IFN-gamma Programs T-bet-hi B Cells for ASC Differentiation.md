...
- **"All minus one" at day 3:** omitting BAFF, IL-2 or IL-21 had little effect on T-bet⁺IRF4⁺ induction (~8% in each). **Omitting IFN-γ left >80% of cells T-bet^neg/lo^ and they failed to upregulate IRF4.** Omitting R848 dropped induction to ~13%
