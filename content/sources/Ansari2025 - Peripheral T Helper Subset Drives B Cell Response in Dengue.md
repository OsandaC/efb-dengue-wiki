...
- **Neutralizing antibody titers (FRNT₅₀) do NOT differ between mild and severe groups** — FRNT₅₀ tested against DENV-2 only (strain S-16803); severe subgroup n=10 only. Replicates the neutralizing Ab paradox direction from COVID-19 ([[Woodruff2020 - Extrafollicular B Cell Responses in COVID-19|Woodruff2020]]) but underpowered and single-serotype-limited.
...
1. **Extends (but does not fully validate) the SLE/COVID-19 EF framework to dengue:** The CD21⁻CD11c⁺ B cells within IgD⁻CD27⁻ are phenotypically consistent with DN2 cells as defined by [[Jenks2018 - Distinct Effector B Cells in SLE|Jenks2018]], but the panel lacks T-bet, CXCR5, and FCRL5 staining — the three markers that formally distinguish DN2 from DN1 or activated memory. The wiki's framing of these as "DN2-like" (rather than confirmed DN2) remains appropriate.
...
3. **Neutralizing Ab paradox replicated in dengue (directionally):** Anti-NS1/anti-prM/M/E IgG up in severe dengue but FRNT₅₀ not different — mirrors the [[Woodruff2020 - Extrafollicular B Cell Responses in COVID-19|Woodruff2020]] finding. However, FRNT used only DENV-2 and severe subgroup was n=10, so this is directionally supportive but underpowered.

4. **Memory B cell preferential response — interpretation uncertain:** Unlike SLE (where naive cells dominate the EF response per [[Jenks2018 - Distinct Effector B Cells in SLE|Jenks2018]]), dengue Tph cells preferentially drive memory B cell differentiation. This is consistent with secondary dengue epidemiology and the [[Singh2026 - DN and Atypical MBC Accumulation in Dengue|Singh2026]] finding that IgM⁺ MBCs are preferentially recalled in 2° infection. **⚠ Council caution:** The coculture used seropositive donor memory T cells (acute cells died) — the memory preference may partly reflect the recall system rather than genuine in vivo precursor biology. This is a fundamental tension with the SLE/COVID-19 naive-derived EF pathway that the paper does not adequately engage with.
...
- **[Council]** The SHM paradox ([[GodoyLozano2016 - Low SHM in Secondary Dengue B Cells|GodoyLozano2016]] low bulk SHM vs [[Priyamvada2016 - Plasmablast BCR Repertoire in Dengue|Priyamvada2016]] high sorted PB SHM) remains completely unresolved — this paper adds cellular phenotyping but no BCR sequencing.
