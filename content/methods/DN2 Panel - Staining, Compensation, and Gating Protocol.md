...
- **Naming drift remains unresolved.** [[DN2 Gating Strategy]]'s panel table still lists APC-Fire750/eFluor506/RB705/BV785 where the confirmed assignments are APC-H7 (CD45), AmCyan (L/D), PerCP-Cy5-5 (CD19), and BV786 (IgD). This page uses the corrected names throughout but does not itself fix the gating-strategy page — that remains an open watch item.
