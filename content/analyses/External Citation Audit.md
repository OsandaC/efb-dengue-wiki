...
| Category | Count |
|----------|-------|
| Unique external papers | 54 |
| Total inline citations across wiki pages | ~80 |
| Wiki pages affected | ~25 |
| DOIs confirmed | 26 |
| DOIs needing verification | 7 |
| DOIs not retrieved | 21 |
...
All 8 ingested source pages were scanned. External citations traced to their ingested source of origin.

## Related Pages

[[Notable Findings]], [[Curator Highlights]]
