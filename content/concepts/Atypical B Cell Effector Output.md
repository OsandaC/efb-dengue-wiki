...
> **★ Evidence-quality warning — read before citing anything below.**
> Only the **ASC/antibody arm** rests on primary human data. The **cytokine-output arm rests almost entirely on a single murine review** ([[Cancro2020 - Age-Associated B Cells]]), and the **antigen-presentation arm is asserted by three reviews and mechanised by none**. **No source in this wiki has measured cytokine secretion by sorted human DN2 cells.** Statements about atypical B cells "driving inflammation through cytokine production" are, at the current state of this evidence base, extrapolations from mouse.

## Key Points from Literature

### Route 1 — ASC differentiation and antibody output (best evidenced)

- DN2 cells are **pre-antibody-secreting cells**: sorted SLE T-bet^hi^ DN2 stimulated for only 2.5 days with R848 + IFN-γ + IL-21 + IL-2 and **no BCR stimulus** gave **≥50-fold more IgG ASCs than naive B cells, and only 2–3-fold fewer than conventional memory** (see [[Zumaquero2019 - IFN-gamma Programs T-bet-hi B Cells for ASC Differentiation]], human, sorted subsets from 3 SLE donors)
- In vitro-generated T-bet^hi^ DN cells yielded **47.2% ASCs after a single division** vs 12.7% for the Th2-driven comparator (see [[Zumaquero2019 - IFN-gamma Programs T-bet-hi B Cells for ASC Differentiation]], human in vitro)
- DN2 cells from SLE patients produce **autoantibodies** and are poised to generate plasmablasts (see [[Jenks2018 - DN2 B Cells and EF Pathway in SLE]], human, n=off-panel SLE cohort)
- Murine T-bet⁺CD11c⁺ B cells contained antibody-secreting cells producing virus-specific IgG **before** any TLR7 stimulation, unlike conventional memory B cells which required it, and on transfer generated a rapid recall IgG response comparable to memory B cells (see [[Song2022 - Tfh Outside Germinal Centers Drive T-bet CD11c B Cells]], murine, 3–5 mice/group)
- **★ An important qualification on autoantibody output:** although murine T-bet⁺CD11c⁺ cells contained a *higher frequency* of autoreactive producers than memory B cells on autoantigen microarray, they **rarely secreted anti-dsDNA or anti-chromatin IgG in the absence of R848** — further differentiation toward ASC is required before they contribute to serum autoreactivity (see [[Song2022 - Tfh Outside Germinal Centers Drive T-bet CD11c B Cells]], murine). Circulating DN2 frequency is therefore not a direct proxy for autoantibody burden.
- The antibody produced by this route is **low-fidelity**: reduced somatic hypermutation and impaired affinity maturation relative to GC output (0.64% vs 0.99% total mutation load; see [[Song2022 - Tfh Outside Germinal Centers Drive T-bet CD11c B Cells]], murine), consistent with the <3% EF benchmark in [[Tipton2015 - ASC Diversity and Origin in SLE]] and the acute-dengue findings of [[GodoyLozano2016 - Lower IgG SHM Rates in Acute Dengue]]
...
- The switch from pre-ASC to ASC requires **IL-21 acting late** (days 3–6 in vitro); IL-21 delivered early produces pre-ASCs that never differentiate (see [[Zumaquero2019 - IFN-gamma Programs T-bet-hi B Cells for ASC Differentiation]], human in vitro)
